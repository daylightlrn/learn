...
## Выполнение
_Создаем две виртуальные машины. На обоих ВМ производим установку СУБД PostgreSQL без инициализации. Первая ВМ (alse174cmdfdt1) будет использоваться для тестирования переноса каталога данных на новый диск. После завершения тестирования диск от первой ВМ будет подключен ко второй (alse174cmdfdt2)._
### 1 и 2
```
