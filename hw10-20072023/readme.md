...
_Создаем подписку на второй ВМ alse174cmdt4 с первой ВМ alse174cmdt3 IP 192.168.186.173. Проверяем состояние подписки. Делаем запросы к таблицам._
...
_Проверяем состояние репликации и информацию о слотах репликации на первой ВМ._
